 ...
 */
// generated on 2022-07-22 using @openmrs/generator-openmrs-owa 0.7.1
'use strict';
...
const THIS_APP_ID = 'openmrs-owa-breastcancerpredict';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      'LOCAL_OWA_FOLDER': '/Users/rayangadmor/openmrs/openmrs-platform/owa/openmrs-owa-breastcancerpredict/app/',
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/openmrs-owa-breastcancerpredict/app/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/openmrs-owa-breastcancerpredict`,
	  css: `${__dirname}/app/css/openmrs-owa-breastcancerpredict.css`,
	  vendor : [
	        	 'jquery' 
